		...
		<div id="main">	
			<div class="wrapper clearfix">
				...
				<div class="masthead clearfix">
					<h1>ABOUT</h1><span class="subheading">Text with icons</span>
				</div>
	        	...
	        	<div id="page-content" class="clearfix">        	
							...
							<div class="one-half">
								...
								@foreach($left_ico_elements as $ico_element)
								@include('components.icon_description', ['ico_element' =>$ico_element])
